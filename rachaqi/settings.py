"""
Django settings for rachaqi project.
...
SECRET_KEY = 'django-insecure-3=+p)_(ag1&57(#fs-gnxsn4#_8_kn_7lcxg_-#l92vlbxbnvr'
...
WSGI_APPLICATION = 'rachaqi.wsgi.application'
